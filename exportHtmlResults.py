...
def saveListofPostings(jobTitle, companyName, jobURL, easilyApply, jobDesc, softSkillList, techSkillList):
    ...
    html_str = html_str + jobTitle + "</h1><h2>EA\t" + companyName + "</h2> <a href=\"" + str(jobURL) + "\"> URL LINK </a><br>" + jobDesc.prettify() + "<h3 style=\"color:green\"><b>TechSkills:</b> <br/> {} </h3> ".format(techSkillList) + "<h3 style=\"color:orange\"><b>SoftSkills:</b> <br/> {} </h3> ".format(softSkillList)
    Html_file.write(html_str)
